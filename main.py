...
parser.add_argument("--LR_path", type = str, default = 'C:/SRGAN_CustomDataset-uav/SRGAN_CustomDataset-main/custom_dataset/hr_train_LR')
parser.add_argument("--GT_path", type = str, default = 'C:/SRGAN_CustomDataset-uav/SRGAN_CustomDataset-main/custom_dataset/hr_train_HR')
